const { WaterModel, Food, Weight } = require("../../models");

const { HttpError, ctrlWrapper } = require("../../helpers");

async function userStatistics(req, res, next) {
  ...
  if (period === "month") {
    ...
    const endDateMonth = new Date(
      new Date(beginDateMonth).setMonth(new Date(beginDateMonth).getMonth() + 1)
    );
...
module.exports = {
  userStatistics: ctrlWrapper(userStatistics),
};
